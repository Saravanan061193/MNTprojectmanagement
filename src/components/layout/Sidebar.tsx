    ...
    return (
        <aside className="w-64 h-screen bg-[#0a0a0a] border-r border-[#1f1f1f] flex flex-col fixed left-0 top-0 z-50">
            ...
            <div className="p-4 border-t border-[#1f1f1f]">
                <button className="flex items-center gap-3 px-3 py-2 rounded-lg text-sm font-medium text-red-400 hover:bg-red-500/10 hover:text-red-300 w-full transition-colors">
                    <LogOut size={18} />
                    Sign Out
                </button>
            </div>
