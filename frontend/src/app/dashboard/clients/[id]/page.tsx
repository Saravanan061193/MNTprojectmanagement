...
export default function ClientProfilePage({ params: paramsPromise }: { params: Promise<{ id: string }> }) {
    ...
    if (loading) return <div className="text-white p-8">Loading Client Profile...</div>;
        ...
        <div className="space-y-8 animate-in fade-in duration-700">
            ...
            <div className="bg-[#111] border border-[#222] rounded-3xl p-8 shadow-2xl relative overflow-hidden">
                ...
                <div className="flex flex-col md:flex-row gap-8 items-start relative z-10">
                    <div className="w-24 h-24 rounded-2xl bg-gradient-to-br from-blue-500 to-purple-600 flex items-center justify-center text-white text-3xl font-bold shadow-xl shadow-blue-500/20">
