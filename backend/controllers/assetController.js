...
// Get All Assets (Admin only ideally, or filtered)
...
exports.createAsset = async (req, res) => {
    try {
        ...
        const newAsset = new Asset({
            ...
            expiryDate: expiryDate || undefined, // Use undefined if null/empty to avoid CastError
        ...
        res.status(500).json({ msg: err.message }); // Send actual error message
    }
};
...
exports.revealAsset = async (req, res) => {
    try {
        ...
        // Check permissions here (e.g. is Admin or allowed user)
